...
class ArtnetUniverseCard extends SettingsCard {
  static GlobalKey<FormState> _formKey = new GlobalKey<FormState>();

  ArtnetUniverseCard(device, onSubmit, onReturn) : super(device, onSubmit, onReturn);
            ...
            Row(
              children: <Widget>[
                ...
                Expanded(
                  flex: 1,
                  child: Tooltip(
                    message: "Artnet universe this device listens to",
                    preferBelow: false,
                    child: Icon(
                      Icons.info_outline,
  ...
  String _validate(String input){
    ...
    if(val is int){
      if(val <= BlizzardWizzardConfigs.artnetMaxUniverses && val >= 0x00){
        return null;
      }
    }

    return "0-${BlizzardWizzardConfigs.artnetMaxUniverses}";
  }
  ...
  void _sendCommand(){
    ...
    tron.addToWaitingList(
      WaitForPacket(this.onReturn,
        ...
        onFailure: "Failed to change Artnet Universe...",
        onSuccess: "Artnet Universe Changed",
      )
    );
