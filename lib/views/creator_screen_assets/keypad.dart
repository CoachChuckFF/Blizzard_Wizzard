  ...
  _handleCommand(String command){
    ...
    if(command == ""){
      ...
      switch(_commandToString()){
        ...
        break;
        case KeypadSecrets.smokey:
          this.messagePresent = true;
          this.command.clear();
          this.command.add(String.fromCharCodes([
            0x57, 0x61, 0x69, 0x74, 0x2e, 0x2e, 0x2e, 0x20, 0x57, 0x68,
            0x61, 0x74, 0x3f,
          ]));
        break;
        case KeypadSecrets.guy:
          this.messagePresent = true;
          this.command.clear();
          this.command.add(String.fromCharCodes([
            0x4a, 0x6f, 0x65, 0x6c, 0x20, 0x69, 0x73, 0x20, 0x53, 0x63,
            0x6f, 0x74, 0x74, 0x27, 0x73, 0x20, 0x67, 0x75, 0x79,
          ]));
        break;
        default:
          this.messagePresent = false;
    ...
    } if(this.command.length >= KeypadSecrets.tickle) {
      this.messagePresent = true;
      this.command.clear();
      this.command.add(String.fromCharCodes([
        0x53, 0x74, 0x6f, 0x70, 0x20, 0x74, 0x68, 0x61, 0x74, 0x20,
        0x74, 0x69, 0x63, 0x6b, 0x6c, 0x65, 0x73, 0x21,
      ]));
    }
